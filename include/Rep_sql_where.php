...
if (isset($EAPDKathg) && $EAPDKathg!='All') { $empwhere = $empwhere." AND ERG_CATEGORY.ECAT_XML_CODE = '".$EAPDKathg."'"; }
if (isset($COSTCID) && $COSTCID!='All') { $empwhere = $empwhere." AND EMPLOYEES.COSTC_ID = ".$COSTCID; }
